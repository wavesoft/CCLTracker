...
\subsubsubsection{CernVM WebAPI Events}
...
\subsubsubsubsection{Sequence of events}
...
\subsubsubsubsection{Sequence of events with WebAPI}
...
\subsubsubsection{Other user actions that could trigger WebAPI events}
